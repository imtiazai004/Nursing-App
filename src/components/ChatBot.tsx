    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      <AnimatePresence>
        {isOpen && !isMinimized && (
          <motion.div
            ...
            className="w-[400px] h-[600px] glass-panel mb-4 flex flex-col overflow-hidden shadow-2xl border-white/20"
          >
            {/* Header */}
            <div className="p-4 border-b border-white/10 bg-blue-500 flex items-center justify-between text-white">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={cn(
            "w-14 h-14 rounded-2xl flex items-center justify-center shadow-2xl transition-all hover:scale-110 active:scale-95 border border-white/20",
