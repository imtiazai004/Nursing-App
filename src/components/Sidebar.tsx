...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, onQuickUpload }) => {
  const items = [
    ...
    { id: 'sources' as ViewState, icon: Files, label: 'Study Sources' },
    { id: 'summarize' as ViewState, icon: FileText, label: 'Summaries' },
    { id: 'quiz' as ViewState, icon: ShieldCheck, label: 'Quiz Mode' },
    { id: 'recommendations' as ViewState, icon: ExternalLink, label: 'Resources' },
  ];

  return (
    <div className="w-64 glass-panel m-6 h-[calc(100vh-48px)] flex flex-col sticky top-6 border-none rounded-[24px]">
